...
export const schoolAndRoutes: SchoolsAndRoutesData[] = [
  {
    ...
    technologies: ['html', 'css', 'javaScript', 'react', 'next', 'reactRouter', 'webpack', 'sass', 'stylus', 'node', 'express', 'sequelize', 'mysql', 'postgres', 'jwt', 'passport', 'git', 'babel', 'npm', 'wsl', 'ubuntuTerminal', 'vsCode', 'eslint', 'nodeMailer', 'dotenv', 'heroku', 'axios', 'docker', 'bcrypt', 'vercel', 'joi']
  },
  {
    id: 2,
    institution: 'Platzi',
